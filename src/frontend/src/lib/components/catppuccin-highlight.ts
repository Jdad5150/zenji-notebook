...
export const catppuccinHighlight = syntaxHighlighting(
	HighlightStyle.define([
		...
		{ tag: [tags.name, tags.definition(tags.name), tags.deleted, tags.character, tags.macroName], color: c.text.hex },
		{ tag: [tags.function(tags.variableName), tags.function(tags.propertyName), tags.propertyName, tags.labelName], color: c.blue.hex },
		{ tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: c.peach.hex },
		{ tag: [tags.self, tags.atom], color: c.red.hex },
		{ tag: [tags.typeName, tags.className, tags.changed, tags.annotation, tags.namespace], color: c.yellow.hex },
